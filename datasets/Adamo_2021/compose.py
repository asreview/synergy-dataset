...
ft_1 = ft_input.iloc[:27, :].copy()
ft_2 = ft_input.iloc[27:31, :].copy()
ft_3 = ft_input.iloc[33:65, :].copy() # We skip 2 lines that contain the wrong DOI

# We replace the 2 wrong DOI records with the correct OpenAlex IDs
ft_manual = pd.DataFrame([
        {"openalex_id": "https://openalex.org/W1485350188"},
        {"openalex_id": "https://openalex.org/W2101266455"},
])
...
ft = pd.concat([ft_1, ft_2, ft_manual, ft_3])
