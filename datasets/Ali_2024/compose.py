...
# process data
search = utils.rename_columns(search, title="Document Title", year="Publication Year", abstract="Abstract", authors="Authors")
search = utils.extract_doi(search, "DOI")

tiab = utils.rename_columns(tiab, title="Document Title", year="Publication Year", abstract="Abstract", authors="Authors")
...
ft = utils.rename_columns(ft, title="Document Title", year="Publication Year", authors="Authors")
