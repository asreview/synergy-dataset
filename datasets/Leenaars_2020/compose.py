...
df_inclusions = pd.read_excel(
    "https://osf.io/download/r94qm/", sheet_name="FT_included"
)[["title"]]
df_inclusions["label_included"] = 1

df_pubmed["pmid"] = None
df_pubmed.loc[df_pubmed["accession_number"].notnull(), "pmid"] = (
    "https://pubmed.ncbi.nlm.nih.gov/"
    + df_pubmed.loc[df_pubmed["accession_number"].notnull(), "accession_number"]
)

df_embase["doi"] = (
    df_embase["url"].str.extract(r"doi\/(10.\S+?)&")[0].apply(unquote_nan)
)
df_embase["pmid"] = (
    "https://pubmed.ncbi.nlm.nih.gov/"
    + df_embase["url"].str.extract(r"pmid\/(\d+)&")[0]
)
