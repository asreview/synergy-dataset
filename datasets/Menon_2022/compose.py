...
df_exclusions = pd.read_csv("https://osf.io/download/y83tu/").rename({'pubmed_id': 'pmid'}, axis=1)
df_inclusions = pd.read_excel("https://osf.io/download/mgxwj/").rename({'DOI name':'doi', 'PubMed ID': 'pmid'}, axis=1)
