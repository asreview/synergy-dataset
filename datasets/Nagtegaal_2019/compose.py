...
for i in [84,86,342,370,433,435,436,457,609,628,696,799,947,957,1030,1134,1534,1537]:
...
df.rename(columns={"included": "label_included", "abstract_included": "label_abstract_screening"}, inplace=True)
