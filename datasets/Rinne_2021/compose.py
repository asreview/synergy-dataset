...
search = utils.rename_columns(search, title="Unnamed: 2", year="Unnamed: 3", authors="Unnamed: 1")
search = search.iloc[1:]
ft = utils.rename_columns(ft, title="Unnamed: 2", year="Unnamed: 3", authors="Unnamed: 1")
ft = ft.iloc[2:]
